    ...
    <el-container style="height: 1000px; border: 1px solid #eee">
      <el-aside width="200px">
        <el-menu :default-openeds="[]">
          <el-submenu index="5">
            <template slot="title"><i class="el-icon-menu"></i>旭日图</template>
            <el-menu-item-group>
              <el-menu-item index="-1" @click="plt_sun(sun)"><i class="el-icon-time"></i>旭日图</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
        </el-menu>
      </el-aside>
...
export default {
  ...
  data() {
    return {
      ...
      options: {
        ...
        tooltip: {
          headerFormat: "",
          pointFormat: '<b>{point.name}</b>的问题数量是：<b>{point.value}</b>'
        }
      }
    }
  ...
  methods: {
    plt_sun(data) {
      ...
      chart.setSize(1250, 900);


      chart.title.update({ 'text': '旭日图' })
      // console.log(data)
